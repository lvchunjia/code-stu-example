...
__DEFINE__(1684595360511, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1684595360512,"./event-store":1684595360513}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684595360512, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1684595360513, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1684595360512,"./utils":1684595360514}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684595360514, function(require, module, exports) {
...
return __REQUIRE__(1684595360511);
})()
