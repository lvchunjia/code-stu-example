    ...
    <div class="container">
      ...
      >
        <rect
          ...
          height="50"
          fill="red"
          transform="translate(10,0) rotate(30) skewX(30) scale(.5)"
        ></rect>
      </svg>
    </div>
