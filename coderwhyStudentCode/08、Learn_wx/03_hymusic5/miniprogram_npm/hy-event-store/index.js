...
__DEFINE__(1684419293770, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1684419293771,"./event-store":1684419293772}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684419293771, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1684419293772, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1684419293771,"./utils":1684419293773}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684419293773, function(require, module, exports) {
...
return __REQUIRE__(1684419293770);
})()
